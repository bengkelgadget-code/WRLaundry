    ...
    function renderStaffTable(keepPage) {
        ...
        var displayData = prodCopy.reverse().filter(function(row) {
            ...
            if (isDateFilterActive && formattedDateFilter) {
                ...
                if (rParts.length === 3) {
                    var rDD = rParts[0].padStart(2, '0');
                    var rMM = rParts[1].padStart(2, '0');
                    var rYYYY = rParts[2];
                    ...
                    matchDate = rowDateRaw.includes(formattedDateFilter) || rowDateRaw.includes(parts[2]);
                }
            }
    ...
    window.addEventListener('resize', function() {
        var viewStaff = document.getElementById('view-staff');
